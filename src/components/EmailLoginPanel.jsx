        ...
        <div className="space-y-3">
          {!isSignup ? (
            <>
              <div>
                <input
                  className={`w-full px-4 py-2 rounded bg-backgrounddark text-white border border-transparent hover:border-secondary1 focus:outline-none focus:border-secondary1 transition-colors ${
            ...
            <div className="p-4 rounded space-y-2">
              <div>
                ...
                <input
                  className={`w-full px-3 py-2 rounded bg-backgrounddark text-white border border-transparent hover:border-secondary1 focus:outline-none focus:border-secondary1 transition-colors ${
                    usernameTouched && !validateUsername(username)
                      ? "border-warningcolor"
                      : "border-transparent"
                  }`}
