...
const intervals = [
  { key: '1', label: '5 s', value: '5s', text: '5s' },
  { key: '2', label: '1 m', value: '1m', text: '1m' },
  { key: '3', label: '15 m', value: '15m', text: '15m' },
  { key: '4', label: '1 h', value: '1h', text: '1h' },
  { key: '5', label: '4 h', value: '4h', text: '4h' },
  { key: '6', label: '1 d', value: '1d', text: '1d' },
  { key: '7', label: '1 w', value: '1w', text: '1w' },
  { key: '8', label: '1 M', value: '1M', text: '1M' },
];
...
export default function ChartPanel() {
  ...
  return (
    <div className="w-full text-body mb-2 sm:mb-0 h-[432px] sm:h-[583px] bg-backgroundmid  border-[1px] border-backgroundlighthover rounded-md flex flex-col">
      {/* Tools Panel */}
