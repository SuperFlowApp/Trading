        ...
        feed.getHistoryKLineData(symbol, { text: interval }).then(() => {
            ...
            chartInstanceRef.current = new KLineChartPro({
                ...
                styles: {
                    ...
                    candle: { // <-- this is the correct key!
                        upColor: '#00005e',         // Green up candle
                        downColor: '#ef5350',       // Red down candle
                        noChangeColor: '#888888',   // Gray for no price change (optional)
                        borderUpColor: '#00005e',   // Green border (optional)
                        borderDownColor: '#ef5350', // Red border (optional)
                        wickUpColor: '#00005e',     // Green wick (optional)
                        wickDownColor: '#ef5350',   // Red wick (optional)
                    }
                },
                indicators: [{ name: 'MA' }],
            });
            // After the chart instance is created, set styles
            chartInstanceRef.current.setStyles({
                candle: {
                    upColor: '#3126a6',
                    downColor: '#ef5350',
                    noChangeColor: '#888888',
                    borderUpColor: '#3126a6',
